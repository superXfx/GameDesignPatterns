...
export default class Goal_MoveLeft extends Goal_Composite {

    private mTargetTriggerType: eTriggerType = eTriggerType.eToLeft;

    public constructor(owner)
    {
        super(owner, eGoalType.eGoal_moveLeft);
    }
