...
import {eTriggerType, TypeToName, eLiveType} from "../../../../Script/DesignPatterns/Trigger/Const_Trigger";
...
export default class Goal_SpeedUp extends Goal_Composite {
    
    private mTargetTriggerType: eTriggerType = eTriggerType.eSpeedUp;

    public constructor(owner)
    {
        super(owner, eGoalType.eGoal_speedUp);
    }
