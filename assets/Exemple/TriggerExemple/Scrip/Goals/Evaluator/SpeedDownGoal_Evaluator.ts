...
export default class SpeedDownGoal_Evaluator extends Goal_Evaluator{

    public SetGoal()
    {
        CocosMessageMgr.getInstance().sendMsg(Const_Msg_Monitor.MSG_ADD_SUBGOAL, {goalType: eGoalType.eGoal_speedDown});
    }
}
