...
export default class Goal_MoveRight extends Goal_Composite {

    private mTargetTriggerType: eTriggerType = eTriggerType.eToRight;

    public constructor(owner)
    {
        super(owner, eGoalType.eGoal_moveRight);
    }
